namespace PurpleIK.UI.Utility
{
    ...
    {
        public static string MailBody(string userName, string actionLink)
        {
            ...
            return $"<html lang=\"en\">" +
                    ...
                    $"@media all {{      .btn-primary table td:hover {{        background-color: #ec0867 !important;      }}  " +
                    ...
                    $".preheader {{      color: transparent;      display: none;      height: 0;      max-height: 0;      max-width: 0;      opacity: 0;      overflow: hidden;      mso-hide: all;      visibility: hidden;      width: 0;    }}        .powered-by a {{      text-decoration: none;    }}        /* -------------------------------------    RESPONSIVE AND MOBILE FRIENDLY STYLES------------------------------------- */        @media only screen and (max-width: 640px) {{      .main p,      .main td,      .main span {{        font-size: 16px !important;      }}      .wrapper {{        padding: 8px !important;      }}      .content {{        padding: 0 !important;      }}      .container {{        padding: 0 !important;        padding-top: 8px !important;        width: 100% !important;      }}      .main {{        border-left-width: 0 !important;        border-radius: 0 !important;        border-right-width: 0 !important;      }}      .btn table {{        max-width: 100% !important;        width: 100% !important;      }}      .btn a {{        font-size: 16px !important;        max-width: 100% !important;        width: 100% !important;      }}    }}    /* -------------------------------------    PRESERVE THESE STYLES IN THE HEAD------------------------------------- */        @media all {{      .ExternalClass {{        width: 100%;      }}      .ExternalClass,      .ExternalClass p,      .ExternalClass span,      .ExternalClass font,      .ExternalClass td,      .ExternalClass div {{        line-height: 100%;      }}      .apple-link a {{        color: inherit !important;        font-family: inherit !important;        font-size: inherit !important;        font-weight: inherit !important;        line-height: inherit !important;        text-decoration: none !important;      }}      #MessageViewBody a {{        color: inherit;        text-decoration: none;        font-size: inherit;        font-family: inherit;        font-weight: inherit;        line-height: inherit;      }}    }}    </style>  </head>  <body>    <table role=\"presentation\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"body\">      <tr>        <td>&nbsp;</td>        <td class=\"container\">          <div class=\"content\">  " +
                    ...
                    $" <tr><td class=\"wrapper\">    " +
                    $"              <p>Hi {userName}</p>   " +
                    $"               <p>PurpleIK uygulamasına yaptığınız kayıt işlemi başarılı olmuştur.Giriş yapabilmek için mail aktivasyonunu gerçekleştirmeniz gerekmektedir.</p>  " +
                    ...
                    $"                          <tbody>     " +
                    $"                           <tr>          " +
                    $"                             <td style=\"color: white;\">Kullanıcınızı Onaylamak İçin <a href=\" {actionLink} \" target=\"_blank\">Tıklayınız</a> </td> " +
                    $"                             </tr>  " +
                    $"                          </tbody>                     " +
                    $"                           </table>  " +
                    $"                     </td>" +
                    ...
                    $"         </table>   " +
                    $"         </div>         " +
                    $"   <!-- END FOOTER -->            <!-- END CENTERED WHITE CONTAINER --></div>        </td>        <td>&nbsp;</td>      </tr>    </table>  </body></html>";


        }

        public static string MailBodyApprove(string userName, string actionLink)
        {
            ...
            return $"<html lang=\"en\">" +
                    ...
                    $" <tr><td class=\"wrapper\">    " +
                    $"              <p>Hi {userName}</p>   " +
                    $"               <p>PurpleIK uygulamasına yaptığınız kayıt işlemi site yöneticisi tarafından onaylanmıştır.</p>  " +
                    $"                <table role=\"presentation\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"btn btn-primary\">  " +
                    $"                  <tbody>   " +
                    $"                   <tr>  " +
                    $"                      <td align=\"left\">    " +
                    ...
                    $"                          <tbody>     " +
                    $"                           <tr>          " +
                    //$"                             <td>Kullanıcınızı Onaylamak İçin <a href=\" {actionLink} \" target=\"_blank\">Tıklayınız</a> </td> " +
                    $"                             </tr>  " +
                    $"                          </tbody>                     " +
                    $"                           </table>  " +
                    $"                     </td>" +
        ...
        public static string MailBodyReject(string userName, string actionLink)
        {
            ...
            return $"<html lang=\"en\">" +
                    ...
                    $" <tr><td class=\"wrapper\">    " +
                    $"              <p>Hi {userName}</p>   " +
                    $"               <p>PurpluIK uygulamasına yaptığınız kayıt işlemi site yöneticisi tarafından reddedilmiştir.</p>  " +
                    $"                <table role=\"presentation\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"btn btn-primary\">  " +
                    $"                  <tbody>   " +
                    $"                   <tr>  " +
                    $"                      <td align=\"left\">    " +
